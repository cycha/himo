...
export const mockLeBonCoinAds = [
  {
    ...
    images: {
      urls: ['https://img.leboncoin.fr/image1.jpg', 'https://img.leboncoin.fr/image2.jpg'],
    },
    location: {
  ...
  },
  {
    ...
    images: {
      urls: ['https://img.leboncoin.fr/image6.jpg'],
    },
    location: {
      region_name: 'Île-de-France',
      department_id: '93',
...
export const expectedPrismaAds = [
  {
    ...
    description:
      'Bel appartement T3 de 65m² situé au 2ème étage sans ascenseur. Comprend 2 chambres, séjour, cuisine équipée, salle de bain. Chauffage individuel gaz. Proximité immédiate métro ligne 7.',
    thumbUrls: ['https://img.leboncoin.fr/image1.jpg', 'https://img.leboncoin.fr/image2.jpg'],
  ...
  },
  {
    ...
    description:
      'Belle maison individuelle de 95m² avec jardin de 200m². Rez-de-chaussée: séjour, cuisine américaine, WC. Étage: 3 chambres, salle de bain. Garage. Proche commerces et écoles.',
    thumbUrls: [
      'https://img.leboncoin.fr/image3.jpg',
      'https://img.leboncoin.fr/image4.jpg',
      'https://img.leboncoin.fr/image5.jpg',
