...
export class AdServicePrisma implements IAdService {
  ...
  private mapToResponseDto(ad: Ad): AdResponseDto {
    return {
      ...
      url: ad.url,
      real_estate_type: ad.realEstateType ?? undefined,
      rooms: ad.rooms ?? undefined,
      surface: ad.surface ?? undefined,
      immo_sell_type: ad.immoSellType ?? undefined,
      price: ad.price,
      provider: ad.provider,
      release_date: ad.releaseDate,
      created_at: ad.createdAt,
      location: {
        region_name: ad.regionName ?? undefined,
        department_id: ad.departmentId ?? undefined,
        department_name: ad.departmentName ?? undefined,
